		...
		<div class="jumbotron primary-background text-white banner-background">
			<div class="container">
				...
				<p>Welcome to technical blog, world of technology.A programming
					language is described by its syntax and semantics . It gets its
					basis from formal languages.</p>
				<p>Programming language theory is the subfield of computer
					science that studies the design, implementation, analysis,
