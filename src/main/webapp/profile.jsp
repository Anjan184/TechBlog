				...
				<div class="modal-body">
					<div class="container text-center">
						...
						<img src="pics/<%=user.getProfile()%>" class="img-fluid"
							style="border-radius: 50%; width: 100px;"> <br>
	...
	<div class="modal fade" id="add-post-modal" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form id="add-post-form" action="AddingPostServlet" method="post"
						enctype="multipart/form-data">
						...
						<div class="form-group">
							<textarea name="pContent" class="form-control"
								style="height: 130px;" placeholder="Enter your content"></textarea>
						</div>

						<div class="form-group">
							<textarea name="pCode" class="form-control"
								style="height: 130px;" placeholder="Enter your program(if any)"></textarea>
						</div>
